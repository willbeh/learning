...
class SeriesWatch {
  SeriesWatch({this.id, this.sid, this.sdata, this.uid, this.date, this.created, this.completed, this.status, this.test, this.enableTest = false});

  String id;
  String sid;
  @JsonKey( toJson: Series.utilToJson)
  Series sdata;
  String uid;
